...
const Icons = {
    ...
    linkedin: (props: IconProps) => (
        <svg viewBox="0 0 448 512" {...props}>
            <path
                fill="currentColor"
                d="M100.28 448H7.4V148.9h92.88V448zM53.79 108.1C24.09 108.1 0 83.87 0 53.79A53.79 53.79 0 1 1 107.57 53.79C107.57 83.87 83.48 108.1 53.79 108.1zM447.9 448h-92.68V302.4c0-34.7-12.47-58.4-43.62-58.4-23.79 0-37.93 16-44.16 31.4-2.27 5.5-2.85 13.1-2.85 20.8V448h-92.69s1.24-242.2 0-267.1h92.69v37.9c12.31-19 34.4-46 83.63-46 61.02 0 106.77 39.8 106.77 125.3V448z"
            ></path>
        </svg>
    ),
